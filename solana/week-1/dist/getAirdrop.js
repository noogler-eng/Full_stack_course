...
const getAirdrop = (address) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const connection = yield new solanaWeb3.Connection(solanaWeb3.clusterApiUrl("devnet"));
        yield connection.requestAirdrop(new solanaWeb3.PublicKey(address), 2 * solanaWeb3.LAMPORTS_PER_SOL);
        return true;
    }
    catch (error) {
